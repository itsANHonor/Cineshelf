        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 p-6">
            ...
            <div className="flex flex-col">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">{media.title}</h2>
              ...
              <div className="space-y-4 mb-6">
                {/* Physical Format */}
                <div>
                  <h3 className="text-sm font-semibold text-gray-700 mb-1">Format</h3>
                ...
                {media.edition_notes && (
                  <div>
                    <h3 className="text-sm font-semibold text-gray-700 mb-1">Edition</h3>
                    <p className="text-gray-900">{media.edition_notes}</p>
                  </div>
                )}
                ...
                {media.region_code && (
                  <div>
                    <h3 className="text-sm font-semibold text-gray-700 mb-1">Region Code</h3>
                    <p className="text-gray-900">{media.region_code}</p>
                  </div>
                )}
                ...
                {media.director && (
                  <div>
                    <h3 className="text-sm font-semibold text-gray-700 mb-1">Director</h3>
                    <p className="text-gray-900">{media.director}</p>
                  </div>
                )}
                ...
                {media.cast && media.cast.length > 0 && (
                  <div>
                    ...
                    <p className="text-gray-900">{media.cast.join(', ')}</p>
                  </div>
                )}
                ...
                {media.synopsis && (
                  <div>
                    ...
                    <p className="text-gray-900 text-sm leading-relaxed">{media.synopsis}</p>
                  </div>
                )}
              </div>
